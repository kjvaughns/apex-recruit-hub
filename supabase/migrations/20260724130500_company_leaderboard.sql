-- =========================================================================
-- APEX Portal — Company-wide leaderboard (Phase 6)
-- Aggregated performance across ALL active users, computed with SECURITY
-- DEFINER so every user sees company-wide totals — WITHOUT exposing any
-- private applicant rows (only safe profile fields + counts are returned).
-- =========================================================================
