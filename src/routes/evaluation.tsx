      ...
      <div className="mx-auto max-w-[720px] px-6 pt-14 pb-24 md:px-8">
        {done ? (
          <div className="vantage-card vantage-card-gold p-10 text-center">
            ...
            <Link to="/" className="vantage-btn-ghost mt-6 inline-flex px-6 py-3 text-[14px]">
              Back to home
            </Link>
          </div>
        ) : (
          <>
            <div className="text-center">
              <div className="vantage-eyebrow-pill mb-5 inline-flex">Final step</div>
            ...
            <div className="vantage-card mt-10 grid gap-4 p-6 md:p-10">
              ...
              <Field label="Why do you want to join Vantage? *">
                <textarea
                  className="vantage-input min-h-[160px] leading-relaxed"
                  rows={6}
                  placeholder="Tell us what's driving you — your goals, your background, and why now."
                  value={why}
                  onChange={(e) => setWhy(e.target.value)}
                />
                <p className="mt-2 text-[12px] text-vantage-faint">
